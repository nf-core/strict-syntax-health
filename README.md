...
- **Last updated:** 2026-07-25 00:39:40 UTC
- **Nextflow version:** 26.07.0-edge

## Pipelines

- **Total:** 0 parse errors, 1304 errors, 6650 warnings across 141 pipelines
- **Zero errors:** 92 pipelines (65.2%)
...
| :white_check_mark: [hadge](https://github.com/nf-core/hadge)                                   |     No      |      0 |       26 |     Yes     |           [View](lint_results/pipeline-results/hadge_lint.md)           |         [View](lint_results/prints-help-results/hadge_help.txt)          |
...
| :white_check_mark: [scdownstream](https://github.com/nf-core/scdownstream)                     |     No      |      0 |       21 |     Yes     |       [View](lint_results/pipeline-results/scdownstream_lint.md)        |      [View](lint_results/prints-help-results/scdownstream_help.txt)      |
...
| :white_check_mark: [genomeqc](https://github.com/nf-core/genomeqc)                             |     No      |      0 |       20 |     Yes     |         [View](lint_results/pipeline-results/genomeqc_lint.md)          |        [View](lint_results/prints-help-results/genomeqc_help.txt)        |
...
| :white_check_mark: [seqsubmit](https://github.com/nf-core/seqsubmit)                           |     No      |      0 |       13 |     Yes     |         [View](lint_results/pipeline-results/seqsubmit_lint.md)         |       [View](lint_results/prints-help-results/seqsubmit_help.txt)        |
...
| :x: [taxprofiler](https://github.com/nf-core/taxprofiler)                             |     No      |   Yes (89)   |        [View](lint_results/workflow-outputs-results/taxprofiler_outputs.md)        |
...
- **Total:** 0 parse errors, 0 errors, 23 warnings across 2000 modules
- **Zero errors:** 2000 modules (100.0%)
...
_Modules with zero errors are not shown above (2000 modules). They may still have warnings. See the [modules results directory](lint_results/module-results/) for all lint outputs._
