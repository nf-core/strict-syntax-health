...
- **Last updated:** 2026-04-10 00:29:17 UTC
- **Nextflow version:** 26.03.2-edge

## Pipelines

- **Total:** 0 parse errors, 2484 errors, 8168 warnings across 134 pipelines
...
- **Total:** 0 parse errors, 0 errors, 1 warnings across 1779 modules
- **Zero errors:** 1779 modules (100.0%)
...
_Modules with zero errors are not shown above (1779 modules). They may still have warnings. See the [modules results directory](lint_results/module-results/) for all lint outputs._
