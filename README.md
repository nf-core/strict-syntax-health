...
- **Last updated:** 2026-05-06 00:38:38 UTC
- **Nextflow version:** 26.04.0

## Pipelines

- **Total:** 0 parse errors, 2358 errors, 7974 warnings across 136 pipelines
- **Zero errors:** 54 pipelines (39.7%)
...
| :x: [diseasemodulediscovery](https://github.com/nf-core/diseasemodulediscovery)              |     No      |     69 |       81 |      -      |  [View](lint_results/pipeline-results/diseasemodulediscovery_lint.md)   |                                    -                                    |
...
| :x: [seqsubmit](https://github.com/nf-core/seqsubmit)                                        |     No      |      1 |        9 |      -      |         [View](lint_results/pipeline-results/seqsubmit_lint.md)         |                                    -                                    |
...
| :white_check_mark: [hlatyping](https://github.com/nf-core/hlatyping)                         |     No      |      0 |        0 |     Yes     |         [View](lint_results/pipeline-results/hlatyping_lint.md)         |       [View](lint_results/prints-help-results/hlatyping_help.txt)       |
