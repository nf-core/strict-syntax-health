...
- **Last updated:** 2026-09-25 00:26:13 UTC
...
| :white_check_mark: [taxmarker](https://github.com/nf-core/taxmarker)                           |     No      |      0 |       20 |     Yes     |         [View](lint_results/pipeline-results/taxmarker_lint.md)         |       [View](lint_results/prints-help-results/taxmarker_help.txt)        |
...
| :x: [rnafusion](https://github.com/nf-core/rnafusion)                                          |     No      |      0 |        0 |     No      |         [View](lint_results/pipeline-results/rnafusion_lint.md)         |       [View](lint_results/prints-help-results/rnafusion_help.txt)        |
...
| :white_check_mark: [smrnaseq](https://github.com/nf-core/smrnaseq)                             |     No      |      0 |        0 |     Yes     |         [View](lint_results/pipeline-results/smrnaseq_lint.md)          |        [View](lint_results/prints-help-results/smrnaseq_help.txt)        |
...
| :x: [ampliseq](https://github.com/nf-core/ampliseq)                                   |     No      |  Yes (106)   |         [View](lint_results/workflow-outputs-results/ampliseq_outputs.md)          |
...
| :x: [epitopeprediction](https://github.com/nf-core/epitopeprediction)                 |     No      |   Yes (19)   |     [View](lint_results/workflow-outputs-results/epitopeprediction_outputs.md)     |
...
| :x: [rnaseq](https://github.com/nf-core/rnaseq)                                       |     No      |  Yes (113)   |          [View](lint_results/workflow-outputs-results/rnaseq_outputs.md)           |
...
| :x: [viralrecon](https://github.com/nf-core/viralrecon)                               |     No      |  Yes (169)   |        [View](lint_results/workflow-outputs-results/viralrecon_outputs.md)         |

</details>

## Modules

- **Total:** 0 parse errors, 0 errors, 29 warnings across 2085 modules
- **Zero errors:** 2085 modules (100.0%)
...
_Modules with zero errors are not shown above (2085 modules). They may still have warnings. See the [modules results directory](lint_results/module-results/) for all lint outputs._

</details>

## Subworkflows

- **Total:** 0 parse errors, 0 errors, 18 warnings across 123 subworkflows
