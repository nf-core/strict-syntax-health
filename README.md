...
- **Last updated:** 2026-07-31 00:37:01 UTC
- **Nextflow version:** 26.07.0-edge

## Pipelines

- **Total:** 0 parse errors, 1296 errors, 6300 warnings across 142 pipelines
...
| :white_check_mark: [funcprofiler](https://github.com/nf-core/funcprofiler)                     |     No      |      0 |       16 |     Yes     |       [View](lint_results/pipeline-results/funcprofiler_lint.md)        |      [View](lint_results/prints-help-results/funcprofiler_help.txt)      |
...
| :white_check_mark: [isoseq](https://github.com/nf-core/isoseq)                                 |     No      |      0 |       10 |     Yes     |          [View](lint_results/pipeline-results/isoseq_lint.md)           |         [View](lint_results/prints-help-results/isoseq_help.txt)         |
...
- **Total:** 0 parse errors, 0 errors, 21 warnings across 2007 modules
- **Zero errors:** 2007 modules (100.0%)
...
_Modules with zero errors are not shown above (2007 modules). They may still have warnings. See the [modules results directory](lint_results/module-results/) for all lint outputs._
