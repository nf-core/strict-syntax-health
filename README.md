...
- **Last updated:** 2026-08-13 00:25:58 UTC
- **Nextflow version:** 26.07.0-edge

## Pipelines

- **Total:** 0 parse errors, 1233 errors, 6276 warnings across 143 pipelines
...
| :white_check_mark: [ampliseq](https://github.com/nf-core/ampliseq)                             |     No      |      0 |       24 |     Yes     |         [View](lint_results/pipeline-results/ampliseq_lint.md)          |        [View](lint_results/prints-help-results/ampliseq_help.txt)        |
...
| :white_check_mark: [genomeqc](https://github.com/nf-core/genomeqc)                             |     No      |      0 |       17 |     Yes     |         [View](lint_results/pipeline-results/genomeqc_lint.md)          |        [View](lint_results/prints-help-results/genomeqc_help.txt)        |
...
| :x: [ampliseq](https://github.com/nf-core/ampliseq)                                   |     No      |  Yes (102)   |         [View](lint_results/workflow-outputs-results/ampliseq_outputs.md)          |
...
| :x: [genomeqc](https://github.com/nf-core/genomeqc)                                   |     No      |   Yes (48)   |         [View](lint_results/workflow-outputs-results/genomeqc_outputs.md)          |
...
| :x: [mag](https://github.com/nf-core/mag)                                             |     No      |   Yes (41)   |            [View](lint_results/workflow-outputs-results/mag_outputs.md)            |
...
- **Total:** 0 parse errors, 0 errors, 22 warnings across 2023 modules
- **Zero errors:** 2023 modules (100.0%)
...
_Modules with zero errors are not shown above (2023 modules). They may still have warnings. See the [modules results directory](lint_results/module-results/) for all lint outputs._
