...
- **Last updated:** 2026-06-05 00:46:53 UTC
- **Nextflow version:** 26.04.3

## Pipelines

- **Total:** 0 parse errors, 1653 errors, 7465 warnings across 137 pipelines
...
| :white_check_mark: [rnasplice](https://github.com/nf-core/rnasplice)                           |     No      |      0 |       33 |     Yes     |         [View](lint_results/pipeline-results/rnasplice_lint.md)         |       [View](lint_results/prints-help-results/rnasplice_help.txt)        |
...
| :white_check_mark: [createpanelrefs](https://github.com/nf-core/createpanelrefs)               |     No      |      0 |        6 |     Yes     |      [View](lint_results/pipeline-results/createpanelrefs_lint.md)      |    [View](lint_results/prints-help-results/createpanelrefs_help.txt)     |
...
| :white_check_mark: [ampliseq](https://github.com/nf-core/ampliseq)                             |     No      |      0 |        0 |     Yes     |         [View](lint_results/pipeline-results/ampliseq_lint.md)          |        [View](lint_results/prints-help-results/ampliseq_help.txt)        |
...
- **Total:** 0 parse errors, 0 errors, 5 warnings across 1863 modules
- **Zero errors:** 1863 modules (100.0%)
...
_Modules with zero errors are not shown above (1863 modules). They may still have warnings. See the [modules results directory](lint_results/module-results/) for all lint outputs._

</details>

## Subworkflows

- **Total:** 0 parse errors, 0 errors, 22 warnings across 117 subworkflows
- **Zero errors:** 117 subworkflows (100.0%)
