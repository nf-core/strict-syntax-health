...
- **Last updated:** 2026-04-15 00:33:54 UTC
- **Nextflow version:** 26.03.2-edge

## Pipelines

- **Total:** 0 parse errors, 2531 errors, 8183 warnings across 134 pipelines
...
| :x: [riboseq](https://github.com/nf-core/riboseq)                                            |     No      |     26 |       56 |      -      |          [View](lint_results/pipeline-results/riboseq_lint.md)          |                                    -                                    |
| :x: [scrnaseq](https://github.com/nf-core/scrnaseq)                                          |     No      |     23 |       95 |      -      |         [View](lint_results/pipeline-results/scrnaseq_lint.md)          |                                    -                                    |
| :x: [circdna](https://github.com/nf-core/circdna)                                            |     No      |     22 |       25 |      -      |          [View](lint_results/pipeline-results/circdna_lint.md)          |                                    -                                    |
...
| :white_check_mark: [bacass](https://github.com/nf-core/bacass)                               |     No      |      0 |       18 |     Yes     |          [View](lint_results/pipeline-results/bacass_lint.md)           |        [View](lint_results/prints-help-results/bacass_help.txt)         |
| :white_check_mark: [rnaseq](https://github.com/nf-core/rnaseq)                               |     No      |      0 |       17 |     Yes     |          [View](lint_results/pipeline-results/rnaseq_lint.md)           |        [View](lint_results/prints-help-results/rnaseq_help.txt)         |
...
| :white_check_mark: [createpanelrefs](https://github.com/nf-core/createpanelrefs)             |     No      |      0 |        1 |     Yes     |      [View](lint_results/pipeline-results/createpanelrefs_lint.md)      |    [View](lint_results/prints-help-results/createpanelrefs_help.txt)    |
...
- **Total:** 0 parse errors, 0 errors, 3 warnings across 1783 modules
- **Zero errors:** 1783 modules (100.0%)
...
_Modules with zero errors are not shown above (1783 modules). They may still have warnings. See the [modules results directory](lint_results/module-results/) for all lint outputs._

</details>

## Subworkflows

- **Total:** 0 parse errors, 0 errors, 7 warnings across 114 subworkflows
