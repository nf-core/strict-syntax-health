...
- **Last updated:** 2026-07-30 00:35:06 UTC
- **Nextflow version:** 26.07.0-edge

## Pipelines

- **Total:** 0 parse errors, 1296 errors, 6314 warnings across 142 pipelines
- **Zero errors:** 94 pipelines (66.2%)
...
| :white_check_mark: [raredisease](https://github.com/nf-core/raredisease)                       |     No      |      0 |       10 |     Yes     |        [View](lint_results/pipeline-results/raredisease_lint.md)        |      [View](lint_results/prints-help-results/raredisease_help.txt)       |
...
| :white_check_mark: [datasync](https://github.com/nf-core/datasync)                             |     No      |      0 |        7 |     Yes     |         [View](lint_results/pipeline-results/datasync_lint.md)          |        [View](lint_results/prints-help-results/datasync_help.txt)        |
...
| :x: [riboseq](https://github.com/nf-core/riboseq)                                     |     No      |  Yes (134)   |          [View](lint_results/workflow-outputs-results/riboseq_outputs.md)          |
...
- **Total:** 0 parse errors, 0 errors, 23 warnings across 2003 modules
- **Zero errors:** 2003 modules (100.0%)
...
_Modules with zero errors are not shown above (2003 modules). They may still have warnings. See the [modules results directory](lint_results/module-results/) for all lint outputs._
