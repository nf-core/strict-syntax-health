...
- **Last updated:** 2026-07-24 00:31:19 UTC
- **Nextflow version:** 26.07.0-edge

## Pipelines

- **Total:** 0 parse errors, 1423 errors, 6691 warnings across 141 pipelines
- **Zero errors:** 90 pipelines (63.8%)
...
| :white_check_mark: [bacmodel](https://github.com/nf-core/bacmodel)                             |     No      |      0 |       55 |     Yes     |         [View](lint_results/pipeline-results/bacmodel_lint.md)          |        [View](lint_results/prints-help-results/bacmodel_help.txt)        |
...
| :white_check_mark: [funcprofiler](https://github.com/nf-core/funcprofiler)                     |     No      |      0 |       19 |     Yes     |       [View](lint_results/pipeline-results/funcprofiler_lint.md)        |      [View](lint_results/prints-help-results/funcprofiler_help.txt)      |
...
| :white_check_mark: [sarek](https://github.com/nf-core/sarek)                                   |     No      |      0 |        6 |     Yes     |           [View](lint_results/pipeline-results/sarek_lint.md)           |         [View](lint_results/prints-help-results/sarek_help.txt)          |
...
- **Total:** 0 parse errors, 0 errors, 22 warnings across 1998 modules
- **Zero errors:** 1998 modules (100.0%)
...
_Modules with zero errors are not shown above (1998 modules). They may still have warnings. See the [modules results directory](lint_results/module-results/) for all lint outputs._
