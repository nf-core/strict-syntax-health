...
- **Total:** 0 parse errors, 1602 errors, 7883 warnings across 139 pipelines
- **Zero errors:** 81 pipelines (58.3%)
...
| :x: [genomeassembler](https://github.com/nf-core/genomeassembler)                              |     No      |     16 |      139 |      -      |      [View](lint_results/pipeline-results/genomeassembler_lint.md)      |                                    -                                     |
...
| :x: [reportho](https://github.com/nf-core/reportho)                                            |     No      |      2 |       96 |      -      |         [View](lint_results/pipeline-results/reportho_lint.md)          |                                    -                                     |
...
| :white_check_mark: [riboseq](https://github.com/nf-core/riboseq)                               |     No      |      0 |      128 |     Yes     |          [View](lint_results/pipeline-results/riboseq_lint.md)          |        [View](lint_results/prints-help-results/riboseq_help.txt)         |
...
| :white_check_mark: [fastquorum](https://github.com/nf-core/fastquorum)                         |     No      |      0 |       10 |     Yes     |        [View](lint_results/pipeline-results/fastquorum_lint.md)         |       [View](lint_results/prints-help-results/fastquorum_help.txt)       |
...
| :white_check_mark: [hlatyping](https://github.com/nf-core/hlatyping)                           |     No      |      0 |        6 |     Yes     |         [View](lint_results/pipeline-results/hlatyping_lint.md)         |       [View](lint_results/prints-help-results/hlatyping_help.txt)        |
...
- **Total:** 0 parse errors, 0 errors, 12 warnings across 1909 modules
- **Zero errors:** 1909 modules (100.0%)
...
_Modules with zero errors are not shown above (1909 modules). They may still have warnings. See the [modules results directory](lint_results/module-results/) for all lint outputs._
