...
- **Last updated:** 2026-06-01 00:43:03 UTC
- **Nextflow version:** 26.04.3

## Pipelines

- **Total:** 0 parse errors, 1688 errors, 7605 warnings across 137 pipelines
...
| :white_check_mark: [rnasplice](https://github.com/nf-core/rnasplice)                           |     No      |      0 |       37 |     Yes     |         [View](lint_results/pipeline-results/rnasplice_lint.md)         |       [View](lint_results/prints-help-results/rnasplice_help.txt)        |
...
- **Total:** 0 parse errors, 0 errors, 5 warnings across 1859 modules
- **Zero errors:** 1859 modules (100.0%)
...
_Modules with zero errors are not shown above (1859 modules). They may still have warnings. See the [modules results directory](lint_results/module-results/) for all lint outputs._
